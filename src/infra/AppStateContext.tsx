  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        id: "2",
        subItems: [
          { name: "No 1.", parentId: "5", id: "31" },
          { name: "No 2.", parentId: "5", id: "32" },
          { name: "No 3.", parentId: "5", id: "33" },
          { name: "No 4.", parentId: "5", id: "34" },
          { name: "No 5.", parentId: "5", id: "35" },
          { name: "No 6.", parentId: "5", id: "36" },
        ],
      },
    ],
  },
    ...
    subItems: [
      {
        ...
        parentId: "Shifts",
        id: "4",
        subItems: [{ name: "Feuillard No. 1", parentId: "8", id: "20" }],
      },
    ],
  },
  {
